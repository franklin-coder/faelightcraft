...
const CategoryShowcase = () => {
  const categories = [
    ...
    },
    {
      id: 'anklets',
      name: 'Anklets',
      description: 'Delicate charms for beach days',
      image: 'https://i.etsystatic.com/12751469/r/il/03e3d1/4893454820/il_fullxfull.4893454820_lira.jpg',
      href: '/products/anklets',
                ...
                <div className="group relative overflow-hidden rounded-xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift">
                  ...
                  <div className="relative aspect-[4/5] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                      ...
                      <Button 
                        variant="secondary"
                        className="w-fit bg-white/20 hover:bg-white/30 text-white border-white/30 hover:border-white/50 transition-all duration-300"
                        size="sm"
                      >
                        Shop Now
