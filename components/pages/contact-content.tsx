  ...
  const contactInfo = [
    {
      ...
      details: ["Victoria, British Columbia", "Canada V8W 2Y2"],
      note: "By appointment only"
    },
    {
      icon: Mail,
      title: "Email Us",
      details: ["hello@faelightcrafts.com", "orders@faelightcrafts.com"],
    ...
    },
    {
      icon: Clock,
      title: "Studio Hours",
      details: ["Monday - Friday: 9AM - 5PM", "Saturday: 10AM - 3PM", "Sunday: Closed"],
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our studio is located in the heart of Victoria, BC - Canada's Garden City. 
            Known for its stunning harbor, vibrant arts scene, and year-round mild climate.
          </p>
        </div>
            ...
            <div className="bg-gray-100 rounded-lg aspect-video flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  We're located in beautiful Victoria, British Columbia
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                We're easily accessible by public transit, and there's plenty of 
                parking nearby. Victoria is served by BC Ferries from Vancouver 
                and the Gulf Islands.
              </p>
            </div>
            
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Book a Visit</h4>
              <p className="text-gray-600 text-sm">
                Studio visits are by appointment only. Contact us to schedule 
                your visit and see our jewelry-making process up close!
              </p>
            </div>
          </div>
        </div>
