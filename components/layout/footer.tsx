...
const Footer = () => {
  return (
    <footer className="bg-[#0A8E81] text-white mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/products/anklets" className="text-sm opacity-90 hover:opacity-100 transition-opacity">Anklets</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm opacity-90">hello@faelightcrafts.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 opacity-80" />
                <span className="text-sm opacity-90">+1 (250) 555-0123</span>
              </div>
            </div>
